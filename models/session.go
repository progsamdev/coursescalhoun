...
func (ss *SessionService) Create(userID string) (*Session, error) {
	...
	token, tokenHash, err := ss.TokenManager.New(ss.BytesPerToken)
...
func (tm *TokenManager) New(bytesPerToken int) (token, tokenHash string, err error) {
	if bytesPerToken < MinBytesPerToken {
		bytesPerToken = MinBytesPerToken
	}
	token, err = rand.Strings(bytesPerToken)
	if err != nil {
